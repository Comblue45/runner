...
class MainMenuButton(Button):
    ...
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(size=(200,100), 
                         text=Text(text="Main menu", color="white", aligment=(1,1)),
    ...
    def on_pressed(self, event: None) -> None:
        ...
        from ....main_menu.main_menu import MainMenu # Done to prevent a circular import
        self.game.add_entity(MainMenu())